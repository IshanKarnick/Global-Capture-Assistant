...
- If you do not want to build from source, download `GlobalCaptureAssistant-1.0.2-win-x64.zip` from the [GitHub releases page](https://github.com/IshanKarnick/Global-Capture-Assistant/releases/).
...
```powershell
.\scripts\package-release.ps1 -Version 1.0.2 -Runtime win-x64
.\scripts\package-release.ps1 -Version 1.0.2 -FrameworkDependent
```
